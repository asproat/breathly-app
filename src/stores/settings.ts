...
interface SettingsStore {
  ...
  setBreathingShapeColor: ( breathingShapeColor: "blue-light" | "lilac" | "pink" | "blue-dark" ) => unknown;
}
  ...
  subscribeWithSelector(
    persist(
      (set, get) => ({
        ...
        setCustomBreathingShapeColor: (customBreathingShapeColor) => set({ customBreathingShapeColor}),
